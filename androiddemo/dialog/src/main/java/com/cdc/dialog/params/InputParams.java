...
public class InputParams implements Parcelable {
     ...
     * 输入框与body视图的距离 dp
     */
    public int[] margins = DialogDefaultValue.INPUT_MARGINS;
    /**
     * 输入框的高度 dp
     */
    public int inputHeight = DialogDefaultValue.INPUT_HEIGHT;
    /**
     * 输入框提示语
     */
     ...
     * 输入框提示语颜色
     */
    public int hintTextColor = DialogDefaultValue.INPUT_TEXT_HINT;
    /**
     * 输入框背景资源文件
     */
     ...
     * 输入框边框线条颜色
     */
    public int strokeColor = DialogDefaultValue.INPUT_STROKE;
    /**
     * 输入框的背景
     */
     ...
     * 输入框字体大小 sp
     */
    public int textSize = DialogDefaultValue.INPUT_TEXT_SIZE;
    /**
     * 输入框字体颜色 rgb
     */
    public int textColor = DialogDefaultValue.INPUT_TEXT;
    /**
     * 输入类型
     */
     ...
     */
    public int[] padding = DialogDefaultValue.INPUT_PADDING;
    /**
     * 字样式
     ...
     * 计数器外边距 [右，下] dp
     */
    public int[] counterMargins = DialogDefaultValue.INPUT_COUNTER_MARGINS;
    /**
     * 计数器字体颜色值 rgb
     */
    public int counterColor = DialogDefaultValue.INPUT_COUNTER_TEXT;
    /**
     * 显示软键盘
     */
