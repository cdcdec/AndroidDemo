...
public class SubTitleParams implements Parcelable {
     ...
     */
    public int[] padding = DialogDefaultValue.SUBTITLE_PADDING;
    /**
     * 标题高度
     */
    public int height;
     ...
     * 标题字体大小
     */
    public int textSize = DialogDefaultValue.SUBTITLE_TEXT_SIZE;
    /**
     * 标题字体颜色
     */
    public int textColor = DialogDefaultValue.SUBTITLE_TEXT;
    /**
     * 标题背景颜色
     */
