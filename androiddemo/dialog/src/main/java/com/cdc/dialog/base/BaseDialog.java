...
import com.cdc.dialog.drawable.CircleDrawable;
import com.cdc.dialog.util.DialogDefaultValue;
import com.cdc.dialog.util.SystemBarConfig;


public abstract class BaseDialog extends DialogFragment{

    private static final String SAVED_GRAVITY = "dialog:baseGravity";
    private static final String SAVED_TOUCH_OUT = "dialog:baseTouchOut";
    private static final String SAVED_CANCELED_BACK = "dialog:baseCanceledBack";
    private static final String SAVED_WIDTH = "dialog:baseWidth";
    private static final String SAVED_HEIGHT_MAX = "dialog:baseMaxHeight";
    private static final String SAVED_PADDING = "dialog:basePadding";
    private static final String SAVED_ANIM_STYLE = "dialog:baseAnimStyle";
    private static final String SAVED_DIM_ENABLED = "dialog:baseDimEnabled";
    private static final String SAVED_BACKGROUND_COLOR = "dialog:baseBackgroundColor";
    private static final String SAVED_RADIUS = "dialog:baseRadius";
    private static final String SAVED_ALPHA = "dialog:baseAlpha";
    private static final String SAVED_X = "dialog:baseX";
    private static final String SAVED_Y = "dialog:baseY";
    ...
    private float mWidth = DialogDefaultValue.DIALOG_WIDTH;//对话框宽度，范围：0-1；1整屏宽
    ...
    private int mRadius = DialogDefaultValue.DIALOG_RADIUS;//对话框的圆角半径
    private float mAlpha = DialogDefaultValue.DIALOG_ALPHA;//对话框透明度，范围：0-1；1不透明
    private int mX, mY;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        CircleDrawable circleDrawable = new CircleDrawable(mBackgroundColor, SystemBarConfig.dp2px(getContext(), mRadius));
        SystemBarConfig.handleBackground(view, circleDrawable);
