...
public class CircleDialogActivity extends AppCompatActivity implements BaseQuickAdapter.OnItemClickListener{
    //全局配置
    static {
            ...
            case 0:
                new CircleDialog.Builder()
                        ...
                        .setOnShowListener(dialog ->
                                Toast.makeText(CircleDialogActivity.this, "显示了！", Toast.LENGTH_SHORT).show())
...
//                                params.backgroundColor = Color.YELLOW;
                        ...
                        .setItems(items, (parent, view1, position1, id) -> {
                                    Toast.makeText(CircleDialogActivity.this, "点击了：" + items.get(position1)
...
//                                        | InputType.TYPE_TEXT_FLAG_MULTI_LINE;
                        ...
                        .setPositiveInput("确定", (text, v) -> {
                            if (TextUtils.isEmpty(text)) {
                                Toast.makeText(CircleDialogActivity.this, "请输入内容", Toast.LENGTH_SHORT).show();
                                return false;
                            } else {
                                Toast.makeText(CircleDialogActivity.this, text, Toast.LENGTH_SHORT).show();
                                return true;
                            }
                        })
                        .show(getSupportFragmentManager());
...
//                        .setProgressDrawable(R.drawable.bg_progress_h)
                ...
                TimerTask timerTask = new TimerTask() {
                    ...
                    public void run() {
                        progress++;
                        if (progress >= max) {
                            CircleDialogActivity.this.runOnUiThread(() -> {
...
//                        .setProgressDrawable(R.drawable.bg_progress_s)
                        ...
                        .setOnCancelListener(dialog -> Toast.makeText(CircleDialogActivity.this, "取消请求", Toast.LENGTH_SHORT).show())
...
//                                params.backgroundColor = Color.YELLOW;
                        ...
                        .setNegative("取消", v ->
                                Toast.makeText(CircleDialogActivity.this, "取消", Toast.LENGTH_SHORT).show())
                        .configNegative(params -> params.styleText = Typeface.BOLD)
                        .setNeutral("中间", v ->
                                Toast.makeText(CircleDialogActivity.this, "中间", Toast.LENGTH_SHORT).show())
            ...
            case 11:
                ...
                new CircleDialog.Builder()
                        ...
                        .setPositive("确定", v -> Toast.makeText(CircleDialogActivity.this
...
//                list.add(new PictureTypeEntity(8, "从相册选择2"));
                ...
                new CircleDialog.Builder()
                        ...
                        .setItems(list, gridLayoutManager, (view13, position13) -> {
                            Toast.makeText(CircleDialogActivity.this, "点击了：" + list.get(position13)
                                    , Toast.LENGTH_SHORT).show();
                            return true;
                        })
                        .setItemsViewBinder((CircleItemViewBinder<PictureTypeEntity>)
...
//                        .setMaxHeight(0.7f)
                ...
                rvAdapter.setOnItemClickListener((adapter1, view14, position14) -> {
                    Toast.makeText(CircleDialogActivity.this, "点击的是：" + adapter1.getData().get(position14), Toast
                            .LENGTH_SHORT).show();
                    dialogFragment.dismiss();
                });
                break;
...
//                        })
            ...
            case 17:
                ...
                weiboRvAdapter.setOnItemClickListener((adapter12, view17, position16) -> {
                    ...
                    Toast.makeText(CircleDialogActivity.this, "" + item.getTitle(), Toast.LENGTH_SHORT).show();
...
//                        .setTitle("Rv Vertical")
                        ...
                        .setItems(rvListForV
                                , (view13, position13) -> {
                                    Toast.makeText(CircleDialogActivity.this
            ...
            case 20:
                new CircleDialog.Builder()
                        ...
                        .setAdResId(R.mipmap.ic_zfbxcc, (view18, position18) -> {
                            Toast.makeText(CircleDialogActivity.this, "点击了"
                                    , Toast.LENGTH_SHORT).show();
                            return true;
                        })
                        .show(getSupportFragmentManager());
            ...
            case 21:
                ...
                new CircleDialog.Builder()
                        ...
                        .setAdUrl(urls, (view18, position18) -> {
                            Toast.makeText(CircleDialogActivity.this, "点击了" + (position18 + 1)
                                    , Toast.LENGTH_SHORT).show();
                            return true;
                        })
...
//                        "http://img.ivsky.com/img/tupian/pre/201707/30/xingganyoumeilidemeinvtupian-005.jpg"
                        , new OnAdItemClickListener() {
                            ...
                            public boolean onItemClick(View view, int position) {
                                Toast.makeText(CircleDialogActivity.this, "点击了第" + (position + 1) + "页", Toast.LENGTH_SHORT)
                                        .show();
                                return true;
                            }
                        })
