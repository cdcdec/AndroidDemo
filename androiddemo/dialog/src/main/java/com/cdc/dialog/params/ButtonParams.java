...
public class ButtonParams implements Parcelable {
     ...
     * 按钮文本颜色
     */
    public int textColor = DialogDefaultValue.FOOTER_BUTTON_TEXT_POSITIVE;
    /**
     * 按钮文本大小 sp
     */
    public int textSize = DialogDefaultValue.FOOTER_BUTTON_TEXT_SIZE;
    /**
     * 按钮高度 dp
     */
    public int height = DialogDefaultValue.FOOTER_BUTTON_HEIGHT;
    /**
     * 按钮背景颜色
     */
     ...
     * 禁用后的按钮文本颜色
     */
    public int textColorDisable = DialogDefaultValue.FOOTER_BUTTON_DISABLE;
    /**
     * 按下颜色值
     */
