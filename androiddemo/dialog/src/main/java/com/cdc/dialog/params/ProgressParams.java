...
public class ProgressParams implements Parcelable {
     ...
     */
    public int[] margins = DialogDefaultValue.PROGRESS_MARGINS;
    /**
     * 底部文字内边距 [left, top, right, bottom]
     */
    public int[] padding = DialogDefaultValue.PROGRESS_TEXT_PADDING;
    /**
     * 进度条资源背景
     */
     ...
     * 文本字体颜色
     */
    public int textColor = DialogDefaultValue.LOADING_TEXT;
    /**
     * 文本字体大小
     */
    public int textSize = DialogDefaultValue.LOADING_TEXT_SIZE;
    /**
     * 字样式
