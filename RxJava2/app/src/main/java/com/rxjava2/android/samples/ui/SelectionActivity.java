...
import com.rxjava2.android.carsonHo.pull.RxJavafixRxjava;
...
public class SelectionActivity extends AppCompatActivity {
    ...
    public void startPullActivity(View view) {
        startActivity(new Intent(SelectionActivity.this, RxJavafixRxjava.class));
    }
}
