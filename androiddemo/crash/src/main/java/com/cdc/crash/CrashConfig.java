...
public class CrashConfig implements Serializable {
    private int backgroundMode = BackgroundMode.BACKGROUND_MODE_SHOW_CUSTOM;
    ...
    public void setBackgroundMode(@BackgroundMode.BackGroundMode int backgroundMode) {
    ...
    public static class Builder {
         ...
         */
        @NonNull
        public Builder backgroundMode(@BackgroundMode.BackGroundMode int backgroundMode) {
         ...
         */
        @NonNull
        public Builder eventListener(@Nullable EventListener eventListener) {
